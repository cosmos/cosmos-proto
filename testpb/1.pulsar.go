...
var (
	...
	fd_Foo_bro protoreflect.FieldDescriptor
	fd_Foo_bar protoreflect.FieldDescriptor
	fd_Foo_baz protoreflect.FieldDescriptor
)

func init() {
	file_testpb_1_proto_init()
	md_Foo = File_testpb_1_proto.Messages().ByName("Foo")
	fd_Foo_bro = md_Foo.Fields().ByName("bro")
	fd_Foo_bar = md_Foo.Fields().ByName("bar")
	fd_Foo_baz = md_Foo.Fields().ByName("baz")
}
...
func (x *fastReflection_Foo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Bro != "" {
		value := protoreflect.ValueOfString(x.Bro)
		if !f(fd_Foo_bro, value) {
			return
		}
	}
	if x.Bar != nil {
	...
	if x.Baz != nil {
		value := protoreflect.ValueOfMessage(x.Baz.ProtoReflect())
		if !f(fd_Foo_baz, value) {
			return
		}
	}
}
...
func (x *fastReflection_Foo) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "Foo.baz":
		x.Baz = value.Message().Interface().(*anypb.Any)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: Foo"))
		}
...
func (x *fastReflection_Foo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "Foo.baz":
		...
		return protoreflect.ValueOfMessage(x.Baz.ProtoReflect())
	case "Foo.bro":
		panic(fmt.Errorf("field bro of message Foo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: Foo"))
		}
...
type Foo struct {
	...
	Bro string              `protobuf:"bytes,1,opt,name=bro,proto3" json:"bro,omitempty"`
	Bar types.Content       `protobuf:"bytes,2,opt,name=bar,proto3" json:"bar,omitempty"`
	Baz authz.Authorization `protobuf:"bytes,3,opt,name=baz,proto3" json:"baz,omitempty"`
}
...
func (x *Foo) GetBaz() authz.Authorization {
	if x != nil {
		return x.Baz
	}
	return nil
...
var file_testpb_1_proto_rawDesc = []byte{
	...
	,
...
var file_testpb_1_proto_depIdxs = []int32{
	...
	4, // 6: Foo.baz:type_name -> google.protobuf.Any
