...
func genMessageKnownFunctions(g *GeneratedFile, f *fileInfo, m *messageInfo) {
	switch m.Desc.FullName() {
	case Any_message_fullname:
	...
	case Duration_message_fullname:
	...
	case ListValue_message_fullname:
	...
	case FieldMask_message_fullname:
	...
	case BoolValue_message_fullname,
		Int32Value_message_fullname,
		Int64Value_message_fullname,
		UInt32Value_message_fullname,
		UInt64Value_message_fullname,
		FloatValue_message_fullname,
		DoubleValue_message_fullname,
		StringValue_message_fullname,
