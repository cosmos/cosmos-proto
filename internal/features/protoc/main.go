...
import (
	"fmt"
	genid2 "github.com/cosmos/cosmos-proto/internal/features/protoc/genid"
	version2 "github.com/cosmos/cosmos-proto/internal/features/protoc/version"
...
func GenerateFile(gen *protogen.Plugin, file *protogen.File, g *generator2.GeneratedFile) *generator2.GeneratedFile {
	// filename := file.GeneratedFilenamePrefix + ".pb.go"
	// g := gen.NewGeneratedFile(filename, file.GoImportPath)
	f := newFileInfo(file)

	genStandaloneComments(g, f, int32(genid2.FileDescriptorProto_Syntax_field_number))
	genGeneratedHeader(gen, g, f)
	genStandaloneComments(g, f, int32(genid2.FileDescriptorProto_Package_field_number))
...
func genFileDescriptor(gen *protogen.Plugin, g *generator2.GeneratedFile, f *fileInfo) {
...
func genReflectFileDescriptor(gen *protogen.Plugin, g *generator2.GeneratedFile, f *fileInfo) {
...
func genStandaloneComments(g *generator2.GeneratedFile, f *fileInfo, n int32) {
...
func genGeneratedHeader(gen *protogen.Plugin, g *generator2.GeneratedFile, f *fileInfo) {
	g.P("// Code generated by protoc-gen-go. DO NOT EDIT.")

	if GenerateVersionMarkers {
		g.P("// versions:")
		protocGenGoVersion := version2.String()
...
func genImport(gen *protogen.Plugin, g *generator2.GeneratedFile, f *fileInfo, imp protoreflect.FileImport) {
...
func genEnumReflectMethods(g *generator2.GeneratedFile, f *fileInfo, e *enumInfo) {
...
func genEnum(g *generator2.GeneratedFile, f *fileInfo, e *enumInfo) {
...
func genMessage(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo) {
	if m.Desc.IsMapEntry() {
		return
	}
...
func genMessageKnownFunctions(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo) {
	switch m.Desc.FullName() {
	case genid2.Any_message_fullname:
	...
	case genid2.Timestamp_message_fullname:
	...
	case genid2.Duration_message_fullname:
	...
	case genid2.Struct_message_fullname:
	...
	case genid2.ListValue_message_fullname:
	...
	case genid2.Value_message_fullname:
	...
	case genid2.FieldMask_message_fullname:
	...
	case genid2.BoolValue_message_fullname,
		genid2.Int32Value_message_fullname,
		genid2.Int64Value_message_fullname,
		genid2.UInt32Value_message_fullname,
		genid2.UInt64Value_message_fullname,
		genid2.FloatValue_message_fullname,
		genid2.DoubleValue_message_fullname,
		genid2.StringValue_message_fullname,
		genid2.BytesValue_message_fullname:
...
func genMessageFields(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo) {
...
func genMessageInternalFields(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo, sf *structFields) {
	g.P(genid2.State_goname, " ", protoimplPackage.Ident("MessageState"))
	sf.append(genid2.State_goname)
	g.P(genid2.SizeCache_goname, " ", protoimplPackage.Ident("SizeCache"))
	sf.append(genid2.SizeCache_goname)
	if m.hasWeak {
		g.P(genid2.WeakFields_goname, " ", protoimplPackage.Ident("WeakFields"))
		sf.append(genid2.WeakFields_goname)
	}
	g.P(genid2.UnknownFields_goname, " ", protoimplPackage.Ident("UnknownFields"))
	sf.append(genid2.UnknownFields_goname)
	if m.Desc.ExtensionRanges().Len() > 0 {
		g.P(genid2.ExtensionFields_goname, " ", protoimplPackage.Ident("ExtensionFields"))
		sf.append(genid2.ExtensionFields_goname)
	}
	if sf.count > 0 {
		g.P()
	}
...
func genMessageField(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo, field *protogen.Field, sf *structFields) {
	...
	name := field.GoName
	if field.Desc.IsWeak() {
		name = genid2.WeakFieldPrefix_goname + name
	}
...
// values of fields.
func genMessageDefaultDecls(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo) {
...
func genMessageMethods(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo) {
	genMessageBaseMethods(g, f, m)
	genMessageGetterMethods(g, f, m)
	genMessageSetterMethods(g, f, m)
}

func genMessageBaseMethods(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo) {
	// Reset method.
...
func genMessageGetterMethods(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo) {
	for _, field := range m.Fields {
		...
		case field.Desc.IsWeak():
			...
			g.P("if x != nil {")
			g.P("w = x.", genid2.WeakFields_goname)
			if m.isTracked {
				g.P("_ = x.", genid2.WeakFieldPrefix_goname+field.GoName)
			}
			g.P("}")
...
func genMessageSetterMethods(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo) {
	for _, field := range m.Fields {
		if !field.Desc.IsWeak() {
			continue
		}
...
func fieldGoType(g *generator2.GeneratedFile, f *fileInfo, field *protogen.Field) (goType string, pointer bool) {
	if field.Desc.IsWeak() {
		return "struct{}", false
	}
...
func fieldDefaultValue(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo, field *protogen.Field) string {
...
func genExtensions(g *generator2.GeneratedFile, f *fileInfo) {
	if len(f.allExtensions) == 0 {
		return
	}
...
func genMessageOneofWrapperTypes(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo) {
...
func genNoInterfacePragma(g *generator2.GeneratedFile, tracked bool) {
	if tracked {
		g.P("//go:nointerface")
		g.P()
	}
...
func genMessageReflectMethods(g *generator2.GeneratedFile, f *fileInfo, m *messageInfo) {
