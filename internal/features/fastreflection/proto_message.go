...
func GenProtoMessage(f *protogen.File, g *generator2.GeneratedFile, message *protogen.Message) {
...
func genMessage(f *protogen.File, g *generator2.GeneratedFile, message *protogen.Message) {
...
func (g *fastGenerator) generateReflectionType() {
	...
	typesVar := copied2.MessageTypesVarName(f)
