...
func getGoType(g *generator2.GeneratedFile, field *protogen.Field) (goType string) {
...
func genPrefValueToGoValue(g *generator2.GeneratedFile, field *protogen.Field, inputName string, outputName string) string {
...
func zeroValueForField(g *generator2.GeneratedFile, field *protogen.Field) string {
	switch field.Desc.Kind() {
	case protoreflect.BoolKind:
		return "false"
	case protoreflect.EnumKind:
